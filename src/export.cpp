...
int main(int argc, char** argv)
{
    ...
    std::filesystem::path original { "original" };
    std::filesystem::path glitch { "glitchy" };
    std::filesystem::create_directories(export_dir / original);
    std::filesystem::create_directories(export_dir / glitch);
